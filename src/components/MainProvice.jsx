			...
			<main className="main-provice">
				...
				<div className="main-info">
					...
					<p className="description">
						...
						qilingan. <br /> 
						Umumiy yer maydoni 166,6 ming kvadrat
						kilometrdan iborat bo‘lib, u hududning kattaligi
						jihatdan O‘zbekiston Respublikasi mintaqalari o‘rtasida
						birinchi o‘rinda turadi. <br />
						Respublika janubiy-g‘arb
						tomondan Qoraqum sahrosiga tutashgan. Uning
						shimoli-g‘arbida Ustyurt pasttekisligi, shimoliy-sharqiy
						tomonida esa Qizilqum sahrosi yastanib yotibdi. Orol
						dengizining janubiy hududi qoraqalpoq zaminida
						joylashgan. Mintaqa yer maydonlarining 80 foizdan
						ortig‘ini qum barxanlaridan iborat cho‘l hududlari
						tashkil qiladi. <br />
						Respublika aholisi (2014 yil boshiga) 1
						million 736 ming kishidan ziyod bo‘lib, aholining milliy
						tarkibida o‘zbeklar 38,1 foizni, qoraqalpoqlar 35,7
						foizni, qozoqlar 18,2 foizni, turkmanlar 5,1 foizni
						ruslar 0,7 foizni koreyslar 0,4 foizni, tatarlar 0,3
						foizni va boshqada millatlar 1,5 foizni tashkil qiladi. <br />
						...
						(66 km) viloyatlari bilan chegaradosh. <br /> Quyi Amudaryoning
						janubiy qismida, qumli kengliklar o‘rtasida
